          ...
          <fieldset className={fieldsetClass}>
            ...
            {card.layout === 'standard' && <>
              <div className="mb-3 grid grid-cols-2 gap-2.5">
                <label className="block"><span className={cn(monoLabel, 'mb-2 block')}>Attack</span><div className="border border-[#30333e] bg-[#11131b] px-2 py-[7px] focus-within:border-[var(--acid)]"><EditableNumber label="Attack" value={card.content.attack} min={0} max={9999} onChange={(value) => patchContent({ attack: Math.round(value) })}/></div></label>
                <label className="block"><span className={cn(monoLabel, 'mb-2 block')}>Defense</span><div className="border border-[#30333e] bg-[#11131b] px-2 py-[7px] focus-within:border-[var(--acid)]"><EditableNumber label="Defense" value={card.content.defense} min={0} max={9999} onChange={(value) => patchContent({ defense: Math.round(value) })}/></div></label>
              </div>
