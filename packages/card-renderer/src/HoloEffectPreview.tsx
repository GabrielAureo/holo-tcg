...
export function HoloEffectPreview({ foil, className = '' }: HoloEffectPreviewProps) {
  ...
  return <span ref={ref} className={`foil-option holo-effect-preview ${className}`.trim()} data-foil={foil} onPointerMove={handlePointerMove} aria-hidden="true"><span className="foil-option-preview" /></span>;
}
